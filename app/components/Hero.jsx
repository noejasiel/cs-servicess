...
const words2 = `  Contamos con un equipo de expertos que se dedica a entender tus necesidades específicas.",
    "Ofrecemos soluciones personalizadas que maximizan el rendimiento de tu negocio.",
    "Nuestra experiencia en el sector garantiza resultados medibles y un servicio excepcional.",
    "Estamos comprometidos con la innovación y la mejora continua para ayudarte a alcanzar tus objetivos.`
