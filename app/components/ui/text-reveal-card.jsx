...
export const TextRevealCard = ({
    ...
    return (
        (<div
            ...
            ref={cardRef}
            className={cn(
                "bg-white border border-white/[0.08] w-[40rem] rounded-lg relative overflow-hidden",
                className
            )}>
            {children}
            <div className="h-40  relative flex items-center overflow-hidden">
                <motion.div
                    ...
                    className="absolute bg-[#05183f] z-20  will-change-transform "
                ...
                <div
                    ...
                    <p
                        className="text-base sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-main "
                        style={{
                            textShadow: "4px 4px 15px rgba(0,0,0,0.5)",
                        }}
                    >
